            ...
            <FadeIn delay={0}>
                <div className="text-center mb-16">
                    ...
                    <p className='text-lg text-white/60 max-w-2xl mx-auto'>
                        Have a project in mind? Let's discuss how can bring your ideas to life.
                    </p>
                </div>
            </FadeIn>
                        ...
                        <form onSubmit={handleSubmit} className='space-y-6'>
                            <div>
                                ...
                                <input
                                    ...
                                    className='w-full px-4 py-3 bg-white/10 border border-white/10 rounded-xl text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all duration-300'
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    className='w-full px-4 py-3 bg-white/10 border border-white/10 rounded-xl text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all duration-300 resize-none'
                                    rows={5}
                            ...
                            {status.message && (
                                <div 
                                    ...
                                    ? 'bg-[#F39C12]/20 text-[#F5B041] border border-[#F39C12]/30 ' 
                                    : 'bg-red-500 text-red-400 border border-red-500/20 '}`} 
                                >
                                    {status.message}
                                </div>
                            )}
                    ...
                    <div className="space-y-8">
                        <div>
                            ...
                            <p className='text-white/60 leading-relaxed'>
                                I'm always open to discussing new projects, creative ideas, or opportunities to be part of your visions. Feel free to reach out through any of the platforms below or send me a message directly using the contact form.
                            </p>
                        </div>

                        <div className="space-y-4">
                            <div className="relative group bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 ">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <a 
                                            ...
                                            className='text-white hover:text-[#F5B041] transition-colors font-medium'
                                        >
                                            {PERSONAL_INFO.email}
                                        </a>
                                    </div>
