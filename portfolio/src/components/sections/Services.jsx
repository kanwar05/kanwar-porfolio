                ...
                {services.slice(0, 2).map((service, index) => {
                    ...
                    return (
                        <FadeIn key={service.id} delay={100 + index * 100}>
                            <div className="group relative bg-white/5 border border-white/10 rounded-3xl p-8 hover:border-primary/30 hover:-translate-y-2 hover:shadow-[0_0_30px_rgba(243,156,18,0.15)] transition-all duration-300 h-full min-h-[280px] flex flex-col ">
                                <div className="mb-6">
                ...
                {services.slice(2).map((service, index) => {
                    ...
                    return (
                        <FadeIn key={service.id} delay={300 + index *100}>
                            <div className="group relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 hover:-translate-y-2 hover:shadow-[0_0_30px_rgba(243,156,18,0.15)] transition-all duration-500 ease-out h-full">
                                <div className="mb-4">
                                ...
                                <div>
                                    <h3 className='text-lg font-semibold text-white mb-2 group-hover:text-[#F5B041] transition-colors duration-300'>
                                        {service.title}
                                    </h3>
