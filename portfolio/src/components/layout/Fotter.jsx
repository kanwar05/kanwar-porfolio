    ...
    <footer className="relative bg-black overflow-hidden border-t border-white/10">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <FadeIn delay={200}>
            <div>
              <h4 className="text-white font-semibold mb-4 text-lg">Connect With Me</h4>
              <p className="text-white/60 text-sm mb-6 leading-relaxed">
                Let's connect and create something amazing together! Whether you have a project in mind, want to collaborate, or just want to say hi, feel free to reach out. I'm always open to new opportunities and connections. You can find me on social media or send me an email. Looking forward to hearing from you!
              </p> 
          ...
          <div className="pt-8 border-t border-white/10">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <p className="flex items-center gap-2 text-white/50 text-sm">
                Build with <Heart className="w-4 h-4 text-primary fill-primary animate-pulse"/> Using React & Tailwind CSS
              </p>
            </div>
          </div>
        </FadeIn>
